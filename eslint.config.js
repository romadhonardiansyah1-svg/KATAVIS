...
export default tseslint.config(
...

  {
    ...
    //
    // Global Node dideklarasikan eksplisit di sini. Berkas agen adalah
    // JavaScript polos, sehingga tidak melewati blok `files: ["**/*.{ts,tsx}"]`
    // di atas — dan tanpa daftar ini, `process`, `Buffer`, dan `fetch`
    // dilaporkan sebagai tidak terdefinisi padahal keduanya memang ada.
    files: ["agent/**/*.js"],
    languageOptions: {
      globals: {
        process: "readonly",
